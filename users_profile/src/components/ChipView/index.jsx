...
function ChipView(props) {
    ...
    const toggle = (value) => (event) => {
        ...
        setValues((values) => {
            ...
            const newValues = values.includes(value) ? values.filter((v) => v !== value) : [...values, value]; return options.filter((option) => newValues.includes(option.value)).map((option) => option.value);
            ...
            {children instanceof Function
                ? options.map((option, index) =>
                    ...
                    children({
                        ...
                        label: option.label, isselected: values.includes(option.value),
        ...
        setOptions: PropTypes.func,
            ...
            values: PropTypes.arrayOf(PropTypes.string),
                ...
                setValues: PropTypes.func,
                    ...
                    childres: PropTypes.oneOfType([PropTypes.func, PropTypes.node]),
